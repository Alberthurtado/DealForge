...
export function CotizacionTemplatePicker({ onApply }: Props) {
          ...
          >
            ...
            <div className="border-b border-gray-100 px-6 py-4 flex items-center justify-between flex-shrink-0">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">
                  Elige una base y personalízala. Puedes editar líneas, precios y T&amp;C después de
                  aplicarla.
                </p>
              </div>
              <button
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <span
                          className={`inline-block mt-1 text-[10px] font-semibold px-2 py-0.5 rounded-full border ${
                            COLOR_MAP[t.color] || COLOR_MAP.blue
                          }`}
                        >
                          {t.sector}
                        </span>
                    ...
                    <div className="space-y-5">
                      ...
                      <div>
                        <h4 className="text-xs font-bold text-gray-700 uppercase tracking-wide mb-2">
                          Líneas que se añadirán ({selected.lineItems.length})
                        </h4>
                      ...
                      <div className="bg-amber-50 border border-amber-100 rounded-lg p-3 text-xs text-amber-900">
                        ⚠️ Al aplicar esta plantilla se{" "}
                        <strong>sustituirán</strong> las líneas, notas y T&amp;C actuales. Podrás
                        editar todo antes de guardar.
                      </div>
                    </div>
                  </>
                ) : (
            ...
            <div className="border-t border-gray-100 px-6 py-4 flex items-center justify-between flex-shrink-0">
              <p className="text-xs text-gray-500">
                💡 Recuerda personalizar los precios y plazos según tu caso concreto.
              </p>

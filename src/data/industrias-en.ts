...
<p>DealForge makes it easy for nutritionists to create proposals with clear service packages, price calculation with a discount for the programme versus a single session, and digital sending to the patient. The electronic signature acts as the patient's formal commitment to the programme, which improves adherence and reduces last-minute cancellations.</p>`,
  ...
  },
  {
    slug: "ecommerce",
    nombre: "E-commerce",
    titulo: "Quote Template for Online Stores & E-commerce",
    descripcion: "Quote online store projects: design, development, payment gateway integration, logistics and e-commerce maintenance.",
    emoji: "🛒",
    color: "#7B1FA2",
    ejemploLineas: [
      { descripcion: "Online store UX/UI design", cantidad: 1, precio: 2500 },
      { descripcion: "Shopify/WooCommerce development", cantidad: 1, precio: 3500 },
      { descripcion: "Payment gateway integration (Stripe/PayPal)", cantidad: 1, precio: 500 },
      { descripcion: "Catalogue upload (up to 200 products)", cantidad: 200, precio: 5 },
      { descripcion: "Shipping and logistics setup", cantidad: 1, precio: 400 },
    ],
    problemas: [
      "Clients who don't understand the difference between platforms (Shopify vs WooCommerce vs custom)",
      "Quotes that don't include recurring costs (hosting, maintenance, fees)",
      "Vague project scope that causes scope creep",
      "No breakdown of integrations and their costs",
    ],
    beneficios: [
      "Platform comparison with pros/cons in the proposal",
      "Initial vs. recurring costs separated clearly",
      "Project phases with milestones and associated payments",
      "Defined post-launch maintenance terms",
    ],
    keywords: ["online store quote", "e-commerce quote", "Shopify quote", "WooCommerce quote", "ecommerce development quote"],
    icp: {
      cargo: "Founder or brand director",
      empresaTipo: "Brand or business wanting to sell online for the first time",
      dolor: "Doesn't know which platform to choose or how much a professional online store should really cost.",
      cita: "I want to understand exactly what I'm paying for and what costs I'll have after launch, not just the development.",
    },
    casoDeUso: {
      antes: "Requested quotes from several agencies and got wildly different figures without understanding what each included. Chose the cheapest, then came the extras.",
      despues: "Receives a proposal with clear phases, development vs. recurring costs, and a platform comparison to make an informed decision.",
      resultado: "The client chooses with full knowledge, there are no cost surprises, and the project is delivered on budget.",
    },
    faqs: [
      { pregunta: "Can I quote development and maintenance costs separately?", respuesta: "Yes, you can create distinct sections: one for the initial project development and another for monthly post-launch maintenance with hosting, updates and support." },
      { pregunta: "How do I reflect payment gateway fees?", respuesta: "In the notes or terms you can state each gateway's fees (Stripe, PayPal) so the client takes them into account as an operating cost." },
      { pregunta: "Can integrations with an ERP or marketplace be quoted?", respuesta: "Each integration is added as an independent line with its price. If there are optional integrations, you can mark them as such so the client decides which to include." },
    ],
    featuresEspecificos: [
      { icono: "ShoppingCart", titulo: "Product catalogue", desc: "Bulk product upload included" },
      { icono: "CreditCard", titulo: "Payment gateways", desc: "Integration and fees detailed" },
      { icono: "Truck", titulo: "Logistics included", desc: "Shipping setup and costs" },
      { icono: "Settings", titulo: "Maintenance", desc: "Post-launch support quoted" },
    ],
    stats: [
      { valor: "Phases", label: "with project milestones" },
      { valor: "Costs", label: "initial vs. recurring" },
      { valor: "Platforms", label: "compared in the proposal" },
    ],
    guia: `<p>Quoting an e-commerce project means distinguishing between the set-up costs and the recurring costs of running the store. The client needs to understand how much it costs to build the online store — design, development, catalogue, payment gateway, logistics setup — and how much it will cost to run it monthly: hosting, maintenance, security updates, technical support and any per-transaction fees from the chosen platform.</p>
<p>The platform choice (Shopify, WooCommerce, PrestaShop, Magento) determines both the initial budget and the operating costs. A professional proposal should compare the viable options for the client's business, stating the advantages and limitations of each based on the number of products, target markets and the team's technical capacity. Detailing the necessary integrations — ERP, CRM, marketplaces, email marketing — avoids budget surprises during development.</p>
<p>DealForge lets e-commerce agencies and freelancers create proposals with project phases (design, development, catalogue upload, testing, launch), delivery milestones and a clear separation of initial vs. recurring costs. The client approves the proposal with electronic signature and both parties have a reference document with the exact project scope.</p>`,
    howToSteps: [
      "Choose the E-commerce template and record the client details and the type of online store.",
      "Structure the quote by phases: design, development, catalogue, integrations, testing and launch.",
      "Separate the set-up costs from the recurring monthly costs (hosting, maintenance).",
      "Detail the necessary integrations and the recommended platform with its justification.",
      "Send the proposal with delivery milestones and receive approval with electronic signature.",
    ],
  },
  {
    slug: "psychology",
    nombre: "Psychology",
    titulo: "Quote Template for Psychologists & Therapists",
    descripcion: "Quote psychology services: individual and couples therapy, psychological assessments and corporate wellbeing programmes.",
    emoji: "🧠",
    color: "#6A1B9A",
    ejemploLineas: [
      { descripcion: "First consultation and assessment", cantidad: 1, precio: 70 },
      { descripcion: "Individual therapy session (50 min)", cantidad: 8, precio: 60 },
      { descripcion: "Psychological report", cantidad: 1, precio: 120 },
      { descripcion: "Online therapy session", cantidad: 4, precio: 55 },
      { descripcion: "Couples therapy session (75 min)", cantidad: 4, precio: 80 },
    ],
    problemas: [
      "Patients who don't commit to the long-term therapeutic process",
      "Rates communicated verbally with no clear structure",
      "Difficulty selling wellbeing programmes to companies",
      "No follow-up of patients who request information but don't return",
    ],
    beneficios: [
      "Therapeutic programmes with defined sessions and duration",
      "Session bundles with the saving detailed",
      "Professional corporate wellbeing proposals",
      "Patient commitment formalised with electronic signature",
    ],
    keywords: ["psychologist quote", "therapy quote", "psychology sessions quote", "corporate wellbeing quote"],
    icp: {
      cargo: "Clinical psychologist or psychotherapist",
      empresaTipo: "Private psychology practice or wellbeing centre",
      dolor: "Patients ask the price per session but can't picture the full process, which leads to premature drop-out.",
      cita: "When I present an 8-12 session programme with clear goals, the patient understands it's a process and commits more.",
    },
    casoDeUso: {
      antes: "Stated the price per session in the first consultation and the patient came 'when they could'. Many left therapy without completing the process.",
      despues: "Presents a therapeutic programme with a recommended number of sessions, goals and a price for the full programme or session bundle.",
      resultado: "Greater treatment adherence because the patient sees the full journey and formally commits to the process.",
    },
    faqs: [
      { pregunta: "Can I offer discounted session bundles?", respuesta: "Yes, you can create lines with bundles of 5, 8 or 12 sessions at a reduced price. The patient sees the saving versus single sessions and commits to the process." },
      { pregunta: "How do I quote wellbeing services for companies?", respuesta: "Create a professional proposal with workshops, group sessions and employee assistance programmes. Companies need a formal quote to approve it internally." },
      { pregunta: "Does the electronic signature serve as informed consent?", respuesta: "The electronic signature validates acceptance of the quote. Clinical informed consent is a separate document, but you can include the general service terms in the quote." },
    ],
    featuresEspecificos: [
      { icono: "Heart", titulo: "Therapeutic programmes", desc: "Sessions with defined goals and duration" },
      { icono: "Gift", titulo: "Session bundles", desc: "Discounted packs to build loyalty" },
      { icono: "Building", titulo: "B2B proposals", desc: "Corporate wellbeing made professional" },
      { icono: "Lock", titulo: "Confidentiality", desc: "Patient data protected" },
    ],
    stats: [
      { valor: "Programmes", label: "with defined goals" },
      { valor: "Bundles", label: "of sessions with savings" },
      { valor: "B2B", label: "proposals for companies" },
    ],
    guia: `<p>Psychologists and psychology practices need quotes that balance the sensitivity of the service with financial transparency. Unlike a conventional purchase, the patient seeking therapy is in a moment of vulnerability and needs clear information without feeling pressured. The proposal should present the service formats — individual, couples, family, child or group therapy — with the recommended frequency and the rates per session or per programme.</p>
<p>Discounted session bundles encourage therapeutic commitment and reduce premature drop-out. For the B2B segment — emotional wellbeing programmes for companies, stress-management workshops, psychometric assessments for recruitment — the proposal should be adapted to corporate language, with measurable objectives, the number of employees covered and reporting on service usage without compromising participants' confidentiality.</p>
<p>DealForge lets psychologists create quotes for both individual patients and corporate programmes, with session bundles, differentiated rates and discreet digital sending. The electronic signature formalises the therapeutic agreement or the corporate contract, and automatic follow-up makes it easy to manage patients pending a response.</p>`,
    howToSteps: [
      "Select the Psychology template and enter the patient's or the company's details.",
      "Define the therapy format and the recommended session frequency.",
      "Offer payment options: single session, discounted session bundle or fixed programme.",
      "For companies: detail the programme objectives, number of employees and confidentiality terms.",
      "Send the proposal discreetly and collect acceptance with electronic signature.",
    ],
  },
  {
    slug: "removals",
    nombre: "Removals",
    titulo: "Quote Template for Removal Companies",
    descripcion: "Quote domestic and international removals: packing, transport, furniture assembly and storage services.",
    emoji: "📦",
    color: "#5D4037",
    ejemploLineas: [
      { descripcion: "Flat move 80m² (2 operatives, van)", cantidad: 1, precio: 650 },
      { descripcion: "Full packing (boxes + protection)", cantidad: 1, precio: 250 },
      { descripcion: "Furniture dismantling and assembly", cantidad: 1, precio: 180 },
      { descripcion: "Hoist service (4th floor, no lift)", cantidad: 1, precio: 200 },
      { descripcion: "Contents insurance (full cover)", cantidad: 1, precio: 80 },
    ],
    problemas: [
      "Quotes that don't detail what's included and what costs extra",
      "Clients who compare prices without considering included services",
      "Disputes over un-quoted items (stairs, large furniture)",
      "Phone quotes with no formal commitment",
    ],
    beneficios: [
      "Detailed services: packing, transport, assembly separately",
      "Clear extras from the start (hoist, storage, insurance)",
      "Formal acceptance before booking the date",
      "Cancellation and amendment terms included",
    ],
    keywords: ["removals quote", "removal company quote", "house move quote", "moving quote", "domestic removals quote"],
    icp: {
      cargo: "Removal company manager",
      empresaTipo: "Local or national removal company of 5-30 employees",
      dolor: "Loses jobs because the client picks the cheapest without knowing they'll be charged for extras that weren't included.",
      cita: "When the client sees everything broken down, they understand my price is fair and that there won't be surprises on moving day.",
    },
    casoDeUso: {
      antes: "Gave quotes over the phone after the client described the move. On arrival, there was furniture not mentioned and the price changed.",
      despues: "Sends a detailed quote with each service, optional extras and clear terms. The client accepts with electronic signature before booking the date.",
      resultado: "Fewer conflicts on moving day, more satisfied clients and fewer last-minute cancellations.",
    },
    faqs: [
      { pregunta: "Can I quote optional services the client can add?", respuesta: "Yes, you can include optional services like packing, furniture dismantling, a hoist service or storage. The client sees the base price and decides which extras to add." },
      { pregunta: "How do I calculate the price by volume or square metres?", respuesta: "You can create lines per type of service with units based on m², volume (m³) or number of items. The system calculates the total automatically." },
      { pregunta: "Can insurance be included in the quote?", respuesta: "Yes, add insurance as a line with the cover detailed in the description. The client clearly sees that their contents are insured." },
    ],
    featuresEspecificos: [
      { icono: "Package", titulo: "Itemised services", desc: "Packing, transport and assembly separated" },
      { icono: "Shield", titulo: "Insurance included", desc: "Cover detailed in the quote" },
      { icono: "Calendar", titulo: "Booking with signature", desc: "Date confirmed with formal acceptance" },
      { icono: "Plus", titulo: "Optional extras", desc: "Hoist, storage, special packing" },
    ],
    stats: [
      { valor: "Everything", label: "itemised, no surprises" },
      { valor: "Insurance", label: "contents cover included" },
      { valor: "Booking", label: "confirmed with signature" },
    ],
    guia: `<p>A removals quote should anticipate all the variables that can increase the cost of the service to avoid surprises on moving day. The volume of the load (measured in cubic metres), the distance between origin and destination, the number of porters, the availability of a lift or furniture hoist, the floor at origin and destination, and access difficulties (pedestrian streets, traffic restrictions) are decisive factors that should appear in the quote.</p>
<p>The removals client fears two things: being charged more than quoted and their belongings being damaged. That's why the quote should clearly state whether it includes packing of fragile items, furniture dismantling and assembly, protective materials and, above all, the contents-insurance cover with the compensation limits per item and per claim. Offering optional services such as storage or cleaning of the origin property adds value and increases the average order value.</p>
<p>DealForge lets removal companies generate detailed quotes with every item broken down, documented contents insurance and a confirmed date booking with electronic signature. The client knows exactly what they're paying and the company has a signed commitment that prevents last-minute cancellations.</p>`,
    howToSteps: [
      "Open the Removals template and enter the client details and the origin and destination of the move.",
      "Estimate the load volume and state the number of porters, vehicle type and access difficulties.",
      "Break down the services: packing, dismantling/assembly, protective materials and storage.",
      "Include the contents-insurance cover with its limits and terms.",
      "Send the quote and confirm the date booking with the client's electronic signature.",
    ],
  },
  {
    slug: "solar-energy",
    nombre: "Solar Energy",
    titulo: "Quote Template for Solar Energy Installers",
    descripcion: "Quote photovoltaic installations: panels, inverters, batteries, permits and maintenance of solar systems.",
    emoji: "☀️",
    color: "#F9A825",
    ejemploLineas: [
      { descripcion: "Solar panels 450W (10 units)", cantidad: 10, precio: 280 },
      { descripcion: "Hybrid inverter 5kW", cantidad: 1, precio: 1200 },
      { descripcion: "Roof mounting structure", cantidad: 1, precio: 600 },
      { descripcion: "Electrical installation + certification", cantidad: 1, precio: 1500 },
      { descripcion: "Grant and export-compensation paperwork", cantidad: 1, precio: 300 },
    ],
    problemas: [
      "Clients who don't understand the difference between kWp, kWh and real output",
      "Technical quotes that scare rather than convince",
      "Competitors who quote without including paperwork or certification",
      "A lack of clarity on return on investment and savings",
    ],
    beneficios: [
      "Equipment detailed with understandable specifications",
      "Paperwork and certification included in the quote",
      "Savings estimate and payback period",
      "Each component's warranties clearly stated",
    ],
    keywords: ["solar installation quote", "solar panels quote", "photovoltaic quote", "solar energy quote", "self-consumption quote"],
    icp: {
      cargo: "Solar installation company manager",
      empresaTipo: "Solar energy installer of 3-20 employees",
      dolor: "Wastes time explaining technical concepts the client doesn't understand, and in the end they pick the competitor who gives a price with no detail.",
      cita: "If the quote is clear and the client understands what they'll save, they decide faster. The problem is many competitors hide costs.",
    },
    casoDeUso: {
      antes: "Made technical quotes in Excel with specifications the client didn't understand. It took hours and then the client chose the cheapest.",
      despues: "Generates a professional quote with detailed equipment, paperwork included, savings estimate and warranties. The client signs digitally.",
      resultado: "Better-informed clients who value the transparency, less time spent on explanations and a higher project close rate.",
    },
    faqs: [
      { pregunta: "Can I include the savings estimate in the quote?", respuesta: "In the notes you can add an estimate of annual production in kWh, the estimated saving in money and the payback period of the investment." },
      { pregunta: "How do I reflect available grants?", respuesta: "You can state the total price and in the terms detail the applicable grants and incentives with their estimated discount. The paperwork cost goes as a separate line." },
      { pregunta: "Can options with and without a battery be quoted?", respuesta: "Create two quotes: a basic installation without a battery and another with storage. The client compares both options and their payback periods." },
    ],
    featuresEspecificos: [
      { icono: "Sun", titulo: "Detailed equipment", desc: "Panels, inverter and battery with specifications" },
      { icono: "FileCheck", titulo: "Paperwork included", desc: "Certification and grants quoted" },
      { icono: "TrendingDown", titulo: "Estimated savings", desc: "Payback and annual output" },
      { icono: "Shield", titulo: "Clear warranties", desc: "25 years panels, 10 years inverter" },
    ],
    stats: [
      { valor: "Savings", label: "estimate included" },
      { valor: "Paperwork", label: "and certification included" },
      { valor: "Warranties", label: "for each component" },
    ],
    guia: `<p>The quote for a photovoltaic solar installation is one of the most technical on the market and, at the same time, the one that most needs to translate engineering data into understandable financial benefits for the owner. The quote should include the sizing of the installation (kWp), the number and model of panels, the type of inverter, the mounting structure, the wiring and the electrical protections, all with reference datasheets.</p>
<p>What really convinces the client is the savings simulation: estimated annual production in kWh, percentage of self-consumption, saving on the electricity bill, payback period and 25-year return. Including the breakdown of administrative paperwork — installation permit, electrical certificate, self-consumption registration and the request for export compensation — shows that the company manages the project from start to finish.</p>
<p>DealForge lets solar energy installers create complete quotes with detailed equipment, an energy-savings simulation, paperwork included and warranties for each component (panels, inverter, installation). The client approves the installation with electronic signature and both parties have a professional document that backs up the investment.</p>`,
    howToSteps: [
      "Select the Solar Energy template and enter the client details and the installation location.",
      "Size the installation: number of panels, peak power, inverter and mounting structure.",
      "Include the savings simulation: estimated production, self-consumption, payback and return.",
      "Detail the administrative paperwork and the warranties for each system component.",
      "Send the quote with all the technical documentation and collect the client's electronic signature.",
    ],
  },
  {
    slug: "fitness",
    nombre: "Fitness & Training",
    titulo: "Quote Template for Personal Trainers & Gyms",
    descripcion: "Quote personal training services, fitness programmes, sports plans and gym services for individuals and companies.",
    emoji: "💪",
    color: "#E53935",
    ejemploLineas: [
      { descripcion: "Initial fitness assessment", cantidad: 1, precio: 50 },
      { descripcion: "Personalised training plan", cantidad: 1, precio: 80 },
      { descripcion: "Personal training sessions (1h)", cantidad: 12, precio: 45 },
      { descripcion: "Basic nutrition follow-up", cantidad: 1, precio: 60 },
      { descripcion: "Monthly review and plan adjustment", cantidad: 3, precio: 30 },
    ],
    problemas: [
      "Clients who buy single sessions with no long-term commitment",
      "No formalisation of the training programme or goals",
      "Difficulty selling session bundles vs. the single session",
      "Competition from fitness apps and cheap online trainers",
    ],
    beneficios: [
      "1-3 month programmes with clear, measurable goals",
      "Session bundles with savings visible to the client",
      "Formal commitment with electronic signature",
      "Professional differentiation from the competition",
    ],
    keywords: ["personal trainer quote", "gym quote", "corporate fitness quote", "training programme quote"],
    icp: {
      cargo: "Personal trainer or gym director",
      empresaTipo: "Personal training studio or boutique gym",
      dolor: "Their clients buy single sessions, don't commit to a programme and drop out before seeing results.",
      cita: "When I present a complete programme with goals and follow-up, they understand it's not just going to the gym — it's a process with results.",
    },
    casoDeUso: {
      antes: "Charged per session and the client came whenever they felt like it. With no plan or commitment, results were slow and they dropped out.",
      despues: "Presents 8- or 12-week programmes with an assessment, sessions, nutrition follow-up and monthly reviews. The client accepts with electronic signature.",
      resultado: "More committed clients, better visible results and greater long-term loyalty.",
    },
    faqs: [
      { pregunta: "Can I create different programme levels?", respuesta: "Yes, you can offer a basic programme (plan + reviews), an intermediate one (plan + sessions + reviews) and a premium one (everything + nutrition). The client chooses by budget." },
      { pregunta: "How do I quote fitness services for companies?", respuesta: "Create a proposal with group sessions, weekly frequency, number of participants and a price per employee or a flat rate. Companies need a formal quote." },
      { pregunta: "Can online and in-person sessions be included?", respuesta: "Each line can specify the format and the price. You can mix in-person sessions with online follow-up in the same programme." },
    ],
    featuresEspecificos: [
      { icono: "Target", titulo: "Measurable goals", desc: "A programme with clear goals from start to finish" },
      { icono: "Repeat", titulo: "Follow-up included", desc: "Monthly progress reviews" },
      { icono: "Gift", titulo: "Session bundles", desc: "Discounted packs that build loyalty" },
      { icono: "Building", titulo: "Corporate fitness", desc: "Professional proposals for companies" },
    ],
    stats: [
      { valor: "Programmes", label: "with measurable goals" },
      { valor: "Bundles", label: "that build client loyalty" },
      { valor: "B2B", label: "fitness for companies" },
    ],
    guia: `<p>The fitness and personal training sector has evolved enormously in its business models: one-to-one training, small groups, online programmes, sport-specific conditioning and corporate wellbeing all coexist in many professionals' offering. The quote should reflect this diversity by presenting programmes with clear, measurable goals — fat loss, muscle gain, rehabilitation, sports performance — rather than selling single sessions with no context.</p>
<p>Session bundles are the loyalty tool par excellence in this sector: a bundle of 10 or 20 sessions with a progressive discount encourages the client's consistency and stabilises the trainer's income. For B2B proposals — employee fitness programmes, group classes in offices or corporate sports centres — the quote should include the weekly frequency, maximum capacity, the equipment needed and programme follow-up metrics.</p>
<p>DealForge lets personal trainers and fitness centres create quotes with training programmes, discounted bundles and corporate proposals, all in a professional document sent digitally. The client signs their commitment to the programme and you manage bundle renewals without paperwork.</p>`,
    howToSteps: [
      "Choose the Fitness template and enter the client's or the company's details.",
      "Define the training programme with goals, weekly frequency and total duration.",
      "Offer options: single session, discounted session bundle or full programme.",
      "For companies: detail capacity, equipment needed, schedules and follow-up metrics.",
      "Send the proposal and formalise the client's commitment with electronic signature.",
    ],
  },
];
